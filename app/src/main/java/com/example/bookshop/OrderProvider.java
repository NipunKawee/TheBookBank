...
public class OrderProvider extends ContentProvider {
    ...
    public Cursor query(Uri uri,  String[] projection, String selection, String[] selectionArgs, String sortOrder) {
        ...
        switch (match) {
            case ORDER:
                cursor = database.query(OrderContract.OrderEntry.TABLE_NAME1, projection, selection, selectionArgs, null, null, sortOrder);
                break;
    ...
    private Uri insertCart(Uri uri, ContentValues values) {
        ...
        long id = database.insert(OrderContract.OrderEntry.TABLE_NAME1, null, values);
    ...
    public int delete( Uri uri,  String selection,  String[] selectionArgs) {
        ...
        switch (match) {
            case ORDER:
                rowsDeleted = database.delete(OrderContract.OrderEntry.TABLE_NAME1, selection, selectionArgs);
                break;
