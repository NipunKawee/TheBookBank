...
public class Book_info extends AppCompatActivity implements LoaderManager.LoaderCallbacks<Cursor>{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        BookName.setText("Harry Potter");


        addtoCart.setOnClickListener(v -> {
            Intent intent = new Intent(Book_info.this, SummaryActivity.class);
        ...
        minusquantity.setOnClickListener(v -> {
            ...
            if (quantity == 0) {
                Toast.makeText(Book_info.this, "Cant decrease quantity < 0", Toast.LENGTH_SHORT).show();
            } else {
                quantity--;
                displayQuantity();
                int bookPrice = basePrice * quantity;
